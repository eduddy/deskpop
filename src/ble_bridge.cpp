...
class RxCallbacks : public BLECharacteristicCallbacks {
  void onWrite(BLECharacteristic* c) override {
    auto v = c->getValue();   // String in newer framework, std::string in older
...
void bleInit(const char* deviceName) {
  ...
  // setEncryptionLevel() was removed in newer ESP32 BLE SDKs; the security
  // mode is fully specified by the BLESecurity block below.
